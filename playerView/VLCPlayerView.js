...
import { StyleSheet, Text, View, Dimensions, TouchableOpacity, ActivityIndicator, StatusBar, BackHandler, Modal, Platform } from "react-native";
...
export default class VLCPlayerView extends Component {
  ...
  onBuffering(event) {
    ...
    if (!this.bufferInterval) {
      this.bufferInterval = setInterval(this.bufferIntervalFunction, 500);
    }
